...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..addBuilderFactory(
          const FullType(BuiltMap,
              const [const FullType(Location), const FullType(String)]),
          () => new MapBuilder<Location, String>())
      ..addBuilderFactory(
          const FullType(BuiltMap,
              const [const FullType(Location), const FullType(String)]),
          () => new MapBuilder<Location, String>())
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.candidates,
          specifiedType:
              const FullType(BuiltList, const [const FullType(String)])),
      'downWords',
      serializers.serialize(object.downWords,
          specifiedType: const FullType(BuiltMap,
              const [const FullType(Location), const FullType(String)])),
      'acrossWords',
      serializers.serialize(object.acrossWords,
          specifiedType: const FullType(BuiltMap,
              const [const FullType(Location), const FullType(String)])),
      'characters',
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'candidates':
          ...
          break;
        case 'downWords':
          result.downWords.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltMap,
                  const [const FullType(Location), const FullType(String)]))!);
          break;
        case 'acrossWords':
          result.acrossWords.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltMap,
                  const [const FullType(Location), const FullType(String)]))!);
          break;
        case 'characters':
...
class _$LocationSerializer implements StructuredSerializer<Location> {
  ...
  Iterable<Object?> serialize(Serializers serializers, Location object,
    ...
    final result = <Object?>[
      'across',
      serializers.serialize(object.across, specifiedType: const FullType(int)),
      'down',
      serializers.serialize(object.down, specifiedType: const FullType(int)),
    ];
  ...
  Location deserialize(Serializers serializers, Iterable<Object?> serialized,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'across':
          result.across = serializers.deserialize(value,
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'character':
          ...
          break;
        case 'acrossWord':
          result.acrossWord = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'downWord':
          result.downWord = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
      }
    }
